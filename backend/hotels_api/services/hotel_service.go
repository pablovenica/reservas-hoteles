...
func (s *hotelService) CreateHotel(hotelDto dto.Hotel) (dto.Hotel, error) {
	...
	// 🔥 PUBLICAR EVENTO hotel.created
	_ = messaging.PublishHotelEvent("hotel.created", map[string]string{
		"hotel_id": created.ID.Hex(),
	})
...
func (s *hotelService) UpdateHotel(id string, hotelDto dto.Hotel) (dto.Hotel, error) {
	...
	// 🔥 PUBLICAR EVENTO hotel.updated
	_ = messaging.PublishHotelEvent("hotel.updated", map[string]string{
		"hotel_id": result.ID.Hex(),
	})
...
func (s *hotelService) DeleteHotel(id string) error {
	...
	// 🔥 PUBLICAR EVENTO hotel.deleted
	_ = messaging.PublishHotelEvent("hotel.deleted", map[string]string{
		"hotel_id": id,
	})
